...
tdf <- as.data.frame(thesis_data_norm)
...
ggplot(tdf, aes(x=CtoU)) +
  geom_histogram(binwidth=100, color="black", fill="cyan") +
...
ggplot(tdf, aes(x=AtoI_TOTALmatches)) +
  geom_histogram(binwidth=800, color="black", fill="lightgreen") +
...
rcorr(tdf$CtoU, tdf$AtoI_TOTALmatches, type = "spearman")
